     ...
     <h3 align="center"><strong><font color="#6600FF">Login First, If New User Create New Account</font></strong></h3>
		...
		<div id="sidebar1">
			<div>
				...
				<ul class="style2">
					<li class="first">
						<h3><font color="#A60000">User Login :</font><a href="adminlogin.jsp"><font color="#FF0000">Admin login :</font></a></h3>
						<p>
						<form action="emp_check1.jsp" name="s" method="post" onsubmit="return valid()">
						<table width="300">
							<tr>
