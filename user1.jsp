	...
	%>
          ...
          <h2 align="center"><font color="#FF0000">My Search</font></h2>
		  		<form action="search.jsp" name="f" method="post" onSubmit="return valid1()">
					<table height="111" align="center">
						<tr>
							<td height="59"><p><input type="text" class="Large" name="search1" size="70"></p></td>	
						</tr>
						<tr>
		...
		<div id="sidebar1">
			<div>
				...
				<ul class="style2">
					<li class="first">
						<h3><a href="a_search.jsp"><strong><font color="#9900FF">Advanced Search</font></strong></a></h3>
					</li>
					<li>
						 <h3><a href="utube.jsp"><font color="#00FFFF"><strong>UTube</strong></font></a></h3>
					</li>
					<li>
						<h3><a href="#"><font color="#9900FF"><strong>My Details</strong></font></a></h3>
					</li>
					<li>
