...
PreparedStatement ps=con.prepareStatement("select  * from video where vid='"+vid1+"' ");
rs=ps.executeQuery();
		...
		<div id="content">
			...
			<div class="post">
				<table width="800" align="center">
					...
					<tr>
						<td align="center"><video width="447px" height="298px" controls> <source src="Gallery/<%=rs.getString(8)%>" type="video/mp4">
...
PreparedStatement ps0=con0.prepareStatement("select  * from comments where vid='"+vid1+"' ");
