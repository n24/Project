...
<div id="wrapper">
	...
	<div id="page" class="container">
		<div id="content">
			<div class="post">
				<h2>Welcome To My Search</h2></div>
			<div class="post">
				<div class="post-title">
					
          <h2 align="center">My Search</h2>
					<table align="center">
						<tr>
							<td><p><input type="text" class="Large" name="search" size="70"></p></td>	
						</tr>
						<tr>
				...
				<ul class="style2">
					<li class="first">
						...
						<table width="300"">
							...
							<tr>
								<td><p>Password</p></td>
								<td><p><input type="password" name="name"></p></td>
							</tr>
							<tr>
								<td>&nbsp;</td>
