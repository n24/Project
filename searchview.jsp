...
<h3 align="right"><a href="utube.jsp"><font color="#0000FF">Home</font></a>&nbsp;&nbsp;<a href="userupload.jsp"><font color="#0000FF">Upload</font></a>&nbsp;&nbsp;<a href="myvideos.jsp"><font color="#0000FF">My VIdeos</font></a>&nbsp;&nbsp;<a href="index.html"><font color="#0000FF">LogOut</font></a>&nbsp;&nbsp;&nbsp;</h3>
		...
		<div id="content">
			...
			<div class="post">
				<table width="800" align="center">
					...
					<tr>
						<td align="center"><video width="447px" height="298px" controls> <source src="Gallery/<%=videoname%>" type="video/mp4">
						...
						<tr><td><p>Video Description :<font color="#FF00FF"><%=rs.getString(5)%></font></p>
                                                        <p>Uploaded By <font color="#FF0000"><%=rs.getString(3)%></font> on <font color="#FF0000"><%=rs.getString(6)%></p> <p><%=rs.getInt(10)%> View(s)</font></p>
                                                        <p> External link: </p>
                                                        <p> <input type ="textbox" name ="exlink" value ="<%=videoname%>"> </input> <p>
						</td></tr>
					<%
						}
					%>
					...
					<table align="left" width="700">
								<form action="comments1.jsp" name="ff" method="post" onSubmit="return valid12()">
								<tr>
									 <td><p><h3><font color="#FF6633">Comments</font></h3></p></td>
								</tr>
								<tr><td align="center" height="59"><p><input type="text" class="Large" name="comment" size="40 ">&nbsp;&nbsp;<input type="submit" value="Post Comment">&nbsp;&nbsp;</p></td></tr>
								</form>
								</table>
    <p>&nbsp;</p>
    <p><br>
		...
		<div id="content">
			...
			<%
		  		 try
					...
					PreparedStatement ps=con.prepareStatement("select  * from video where (category='"+c+"' OR name='"+nm+"') AND vid <>'"+vid+"' order by RAND() limit 4");
					rs=ps.executeQuery();
					//ResultSet rs=ps.executeQuery();
					%>
					...
					<li class="first"><a href="searchview.jsp?id=<%=rs.getString(1)%>">
