...
PreparedStatement ps=con.prepareStatement("select  * from video where vid='"+vid+"' ");
rs=ps.executeQuery();
				...
				<table width="800" align="center">
					...
					<tr>
						...
						<p>Uploaded By <font color="#FF0000"><%=rs.getString(3)%></font> on <font color="#FF0000"><%=rs.getString(6)%></p> <p><%=rs.getInt(10)%> View(s)</font></p>
                                                        <p> External link: </p>
                                                        <p> <input type ="textbox" name ="exlink" value ="<%=videoname%>"> </input> <p></p>
						</td></tr>
					<%
						}
					%>
...
PreparedStatement ps0=con0.prepareStatement("select  * from comments where vid='"+vid+"' ");
		...
		<div id="content">
			...
			<%
		  		 try
					...
					con = databasecon.getconnection();
					st=con.createStatement();
					PreparedStatement ps=con.prepareStatement("select  * from video order by RAND() limit 4");
					rs=ps.executeQuery();
					//ResultSet rs=ps.executeQuery();
					%>
