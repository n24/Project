...
<div id="wrapper">
	...
	%>
		...
		<form action="search.jsp" name="f" method="post" onSubmit="return valid1()">
				<table align="center">
					<tr><td height="59"><p><input type="text" placeholder="Search Here" class="Large" name="search1" size="70">&nbsp;&nbsp;<input type="submit" value="Search">&nbsp;&nbsp;</p></td></tr>
				</table>
			</form>
			<div class="post">
        <h2><strong><font color="#FF0000">Upload Your Video</font></strong></h2>
				<table width="600">
					<form name="f3" action="insertvideo1.jsp" method="post"  enctype="multipart/form-data">
		...
		<div id="sidebar1">
			<div>
				...
				<ul class="style2">
					...
					<li>
						<h3><a href="#"><font color="#00FFFF"><strong>Upload Video</strong></font></a></h3>
					</li>
					<li>
